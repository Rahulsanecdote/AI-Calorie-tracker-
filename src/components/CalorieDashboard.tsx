...
export default function CalorieDashboard({ totals, settings }: CalorieDashboardProps) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm p-6">
      ...
      {/* Macro Breakdown */}
      <div>
        <h3 className="text-sm font-medium text-gray-700 mb-3">Macronutrients</h3>
        <div className="h-40">
        ...
        <div className="flex justify-around mt-4 text-sm">
          <div className="text-center">
            ...
            <div className="text-xs text-gray-400">Goal: {settings.proteinGoal_g}g</div>
          </div>
          <div className="text-center">
            <div className="font-semibold text-amber-500">{totals.carbs_g}g</div>
            <div className="text-gray-500">Carbs</div>
            <div className="text-xs text-gray-400">Goal: {settings.carbsGoal_g}g</div>
          </div>
          <div className="text-center">
            <div className="font-semibold text-red-500">{totals.fat_g}g</div>
            <div className="text-gray-500">Fat</div>
            <div className="text-xs text-gray-400">Goal: {settings.fatGoal_g}g</div>
          </div>
        </div>
      </div>
    </div>
